...
#define OTA_EEPROM_CRC_ADDR      0x17    /* CRC32 (4 bytes LE) */
...
#define OTA_ERR_CRC_MISMATCH  0x06  /* CRC32 mismatch */
...
typedef struct {
    ...
    uint32_t    expected_crc;                  /* Expected CRC32 (from END frame) */
} OTA_Storage_t;
...
/* Set expected CRC32 (parsed from UPDATE_END frame) */
